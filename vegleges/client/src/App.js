...
export default function App(){
  ...
  const [UserLoginPP, setUserLoginPP] = useState('');
    ...
    const checkLoginStatus = () => {
        Axios.get('http://localhost:3001/api/login/user').then((response) => {
          if(response.data.loggedIn === true){
              ...
              setUserLoginPP(response.data.user[1].UserPP);
          }
      });
    }
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title="Admin" id="collasible-nav-dropdown">
              <NavDropdown.Item href="/articleslist">Articles</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="/userlist">Users</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="/commentlist">Comments</NavDropdown.Item>
            </NavDropdown>
          </Nav>
          ...
          {LoginStatus && (
            <NavDropdown title={LoginName} id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="profilePage" img src={UserLoginPP} alt="val.UserPP" className="topAvatar" >Profile</NavDropdown.Item>
              <NavDropdown.Divider />
