            ...
            return(
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" placeholder={val.userNameUpd}{
                            ...register("userUnUpd", {
                                minLength: 6,
                                maxLength: 20,
                    ...
                    <div className="form-group">
                        ...
                        <input type="url" className="form-control" placeholder={val.userPPUpd}{
                            ...register("userPPUpd", {
                                minLength: 8,
                                maxLength: 100,
                            })
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" className="form-control" placeholder={val.userPwUpd}{
                            ...register("userPwUpd", {
                                minLength: 8,
                                maxLength: 16,
                            })
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" placeholder={val.userFNUpd}{
                            ...register("userFNUpd", {
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" placeholder={val.userSNUpd}{
                            ...register("userSNUpd", {
                                minLength: 3, //Mennyi legyen?
                                maxLength: 20, //Mennyi legyen?
                            })
                    ...
                    <div className="form-group">
                        ...
                        <input type="email" className="form-control" placeholder={val.userEmailUpd}{
